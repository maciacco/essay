...
\renewcommand{\abstractname}{\vspace{-\baselineskip}}
    ...
    \begin{abstract}
    La produzione di una coppia $\mu^+\mu^-$ dall'annichilazione elettrone-positrone è un processo studiato negli esperimenti ai collider $e^+e^-$ e trova
    la sua descrizione teorica nel contesto del Modello Standard. In questo \textit{essay} sono calcolati i termini d'interazione leptone-antileptone-scalare necessari per il calcolo
    completo dell'ampiezza del processo ed è verificata l'indipendenza dell'elemento di matrice $S$ dalla scelta di gauge all'ordine perturbativo più basso.
