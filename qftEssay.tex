...
\renewcommand{\abstractname}{\vspace{-\baselineskip}}
    ...
    % HIGGS x WEAK
    \begin{equation}
    \frac{1}{4}\sum_{spin} M_4 M_2^{\dagger}=\frac{1}{4}\sum_{spin} M_2 M_4^{\dagger}=-\left(\frac{g}{2}\right)^2\frac{(m_em_\mu)^2}{M_W^2}\frac{e^2}{(s-M_Z^2)(s-M_H^2)}\{ (u-m_e^2-m_\mu^2)-(t-m_e^2-m_\mu^2) \}
    \end{equation}
