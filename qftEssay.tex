...
\renewcommand{\abstractname}{\vspace{-\baselineskip}}
    ...
    \end{equation}
    da cui si estrae il vertice a tre linee con il campo $Z_\mu$ (risp. $A_\mu$) e la coppia leptone-antileptone, di valore $i(g/4c)\gamma^\mu(V+\gamma^5)$ (risp. $-ie\gamma^\mu$). Si è posto $c\equiv\cos\theta_W$ e $V\equiv4\sin^2\theta_W+1$.
    ...
    Inserendo la parametrizzazione (\ref{PhiParameterization}) nella lagrangiana d'interazione (\ref{YukawaCouplings}) si esplicitano i termini di lagrangiana d'interazione per i singoli campi
